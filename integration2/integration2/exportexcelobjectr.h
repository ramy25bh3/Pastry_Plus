#ifndef EXPORTEXCELOBJECTR_H
#define EXPORTEXCELOBJECTR_H
...
class ExportExcelObjectr : public QObject
{
    Q_OBJECT
public:
    ExportExcelObjectr(const QString &filepath, const QString &sheettitle,
                      QTableView *tableview):excelFilePath(filepath),
                      sheetName(sheettitle), tableView(tableview){}

    ~ExportExcelObjectr() {QSqlDatabase::removeDatabase("excelexport");}
